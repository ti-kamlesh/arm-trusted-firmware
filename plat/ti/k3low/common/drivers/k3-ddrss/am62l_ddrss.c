...
int am62l_lpddr4_init(void)
{
	...
	driverdt->writectlconfigex(pd, am62lx_ddr_cfg.ctl_data, TI_LPDDR4_INTR_CTL_REG_COUNT);
	driverdt->writephyindepconfigex(pd, am62lx_ddr_cfg.pi_data, TI_LPDDR4_INTR_PHY_INDEP_REG_COUNT);
	driverdt->writephyconfigex(pd, am62lx_ddr_cfg.phy_data, TI_LPDDR4_INTR_PHY_REG_COUNT);
