...
#define TI_LPDDR4_INTR_MAX_CS (2U)

#define TI_LPDDR4_INTR_CTL_REG_COUNT (423U)

#define TI_LPDDR4_INTR_PHY_INDEP_REG_COUNT (345U)

#define TI_LPDDR4_INTR_PHY_REG_COUNT (1406U)
...
} ti_lpddr4_intr_phyindepinterrupt;
