...
static inline void mem_ti_clk_writel(const struct resource_mem *mem, uint32_t a,
				     uint32_t off)
{
...
static inline void mem_writew(const struct resource_mem *mem, uint16_t a,
			      uint32_t off)
{
...
static inline void mem_writeb(const struct resource_mem *mem, uint8_t a,
			      uint32_t off)
{
