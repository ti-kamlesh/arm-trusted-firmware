...
static struct power_domain scmi_power_domains[] = {
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_MAIN_GPIOMUX_INTROUTER0, str(GPIOMUX_INTR0)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_DMASS0_XLCDMA_0, str(WKUP_DMSS_XLCD0)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_DEEPSLEEP_SOURCES0, str(DEEPSLEEP_SRC0)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_TRNG_DRBG_EIP76D_WRAP0, str(TRNG_EIP76D_WRP)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_GTCCLK_SEL_DEV_VD, str(WKUP_GTC_SEL_VD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_OBSCLK_MUX_SEL_DEV_VD, str(WK_OBSCLK_MUXVD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_CLKOUT_SEL_DEV_VD, str(WKUP_CLKOUT_VD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_OBSCLK0_MUX_SEL_DEV_VD, str(OBSCLK0_MUX_VD)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_TIMER1_CLKSEL_VD, str(TIMER1_CLKSEL)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_TIMER3_CLKSEL_VD, str(TIMER3_CLKSEL)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD, str(WK_TMR1_CLKSEL)),
};
