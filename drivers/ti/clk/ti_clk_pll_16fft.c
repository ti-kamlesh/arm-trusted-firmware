...
/**
 * pll_16fft_pllm_valid() - Check if a pllm value is valid for this PLL.
 * @clock_ptr: unused.
...
/**
 * pll_16fft_bin() - Assign a bin preference for a given PLL configuration.
 * @clock_ptr: unused.
 * @plld: unused.
 * @pllm: unused.
 * @is_frac: True if fractional mode is in use.
...
/**
 * pll_16fft_vco_fitness() - Return a fitness score for a VCO frequency.
 * @clock_ptr: unused.
...
/**
 * pll_16fft_clkod_valid() - Check if a clkod value is valid for this PLL.
 * @clock_ptr: unused.
...
/**
 * clk_pll_16fft_cal_option3() - Perform option 3 PLL calibration.
...
/**
 * clk_pll_16fft_check_lock() - Check if the PLL VCO/DCO is locked.
 * @pll: PLL instance data.
 *
...
#if defined(CONFIG_CLK_PLL_16FFT_FRACF_CALIBRATION)
/**
 * clk_pll_16fft_check_cal_lock() - Check if PLL deskew calibration is complete.
 * @pll: PLL instance data.
 *
...
/**
 * clk_pll_16fft_is_bypass() - Query the bypass state of the PLL.
 * @pll: PLL instance data.
 *
...
/**
 * clk_pll_16fft_internal_set_freq_from_pll_table() - Set frequency using a PLL table entry.
...
/**
 * clk_pll_16fft_set_freq() - Set the 16FFT PLL output frequency.
...
/**
 * clk_pll_16fft_get_freq() - Return the 16FFT PLL DCO frequency.
...
/**
 * clk_pll_16fft_get_state() - Get the hardware state of the 16FFT PLL.
 * @clock_ptr: The PLL clock instance.
 *
