...
/**
 * pll_consider_entry() - Evaluate a PLL table entry as a candidate frequency.
...
/**
 * pll_consider() - Evaluate a plld/pllm/pllfm/clkod combination as a best match candidate.
 * @data: PLL search state including target, min, max and best-match tracking.
...
/**
 * pll_find_pllm() - Find floor and ceiling pllm values around an ideal value.
...
/**
 * pll_internal_calc() - Calculate ideal plld/pllm/clkod values for a given input frequency.
