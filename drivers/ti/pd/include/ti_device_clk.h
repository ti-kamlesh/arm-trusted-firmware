 ...
 * invalid.
 */
const struct ti_dev_clk_data *get_dev_clk_data(struct ti_device *dev, ti_dev_clk_idx_t clk_idx);
 ...
 * TI_DEV_CLK_ID_NONE if clk_idx was invalid, is not a mux, or does not point to
 * a valid clock.
 */
 ...
 * TI_DEV_CLK_ID_NONE is returned.
 */
...
#else
static inline void ti_device_clk_enable(struct ti_device *dev, ti_dev_clk_idx_t clk_idx)
{
}
static inline void ti_device_clk_disable(struct ti_device *dev, ti_dev_clk_idx_t clk_idx)
{
}
static inline void ti_device_clk_init(struct ti_device *dev, ti_dev_clk_idx_t clk_idx)
{
}
#endif
