...
#define TI_DEV_ID_NONE			((dev_idx_t) (-1L))
...
#define TI_DEV_POWER_ON_ENABLED_HOST_IDX	HOST_ID_CNT
...
#define TI_DEV_FLAG_ENABLED_MASK		(((1ULL << (HOST_ID_CNT + 1ULL)) - 1ULL) << 5ULL)
 ...
 */
static inline struct ti_device *ti_device_lookup(dev_idx_t id)
{
